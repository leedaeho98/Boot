...
import com.shoping.entity.QItem;
...
class ItemRepositoryTest {
    ...
    // 상품명이  테스트 상품이 1 또는 상품상세설명이 테스트 상품 상세 설명5이면 데이터 출력
    @Test
    ...
    // 테스트 상품 상세 설명이 붙은 데이터를 내림차순으로 전체 조회
    @Test
    @DisplayName("Query를 이용한 상품 조회 테스트")
    public void findByItemDetWailTest(){
        this.createItemTest();
